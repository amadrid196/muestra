...
<main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
    <div class="col-12 col-md-12">
            <h6><router-link to="/menu">menu</router-link> \ departamento</h6>
        <div class="card">
            <div class="card-body">

                <div class="form-row">
                <div class="form-group col-12 col-md-8">
                <router-link to="/menu/departamento-crear" >
                    ...
                    <div class="form-group col-12 col-md-4">
                        <div class="input-group mb-2">
                            ...
                            <input v-model="search" @keyup="getDepartamento(1, search)" type="search" class="form-control" id="inputPassword4" placeholder="Busqueda">
                        </div>
                    </div>
                </div>
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr v-for="item in departamento" v-bind:key="item.id_departamento">
                                ...
                                <td>{{item.estado}}</td>
                            <td>
                            <router-link :to="{name: 'crear-departamento', params: { data: item}}"> <i title="Editar" class="bi bi-pencil-square" ></i>
                            </router-link>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" v-on:click="deleteDepartamento">Aceptar</button>
...
import crearDepartamento from '../departamentos/departamento_crear.vue'
export default {
 components: {
    crearDepartamento,
  },
  ...
  methods:{
      getDepartamento: function(page, search){
      let url = `/getDepartamento?page=${page}&search=${search}`;
      axios
        .get(url)
        .then((response) => {
            this.departamento = response.data.departamentos.data;
      ...
      obtenerId: function (data = [], accion = ''){
          this.iddepartamentos = data.id_departamento;
          this.accion = accion;
          if(accion == '3'){
    ...
    deleteDepartamento: function(){
      ...
      axios
        ...
        this.getDepartamento(this.current_page, "");
        })
        .catch((err) => {
          console.log(err);
        });
    ...
    cambiarPagina: function (page, search) {
      ...
      this.getDepartamento(page, search);
    },
  },
      created: function () {
        this.getDepartamento(1, this.search);
    },
    mounted() {
        this.getDepartamento(1, this.search);
    }
